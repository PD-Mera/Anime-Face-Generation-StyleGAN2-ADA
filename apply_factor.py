...
def generate_images(z, label, truncation_psi, noise_mode, direction, file_name):
    ...
    img4 = G(z + 2 * direction, label, truncation_psi=truncation_psi, noise_mode=noise_mode)
    img5 = G(z - 2 * direction, label, truncation_psi=truncation_psi, noise_mode=noise_mode)
    return torch.cat([img5, img3, img1, img2, img4], 0)
